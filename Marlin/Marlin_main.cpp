...
void setup()
{
  ...
  SERIAL_ECHOLNPGM(VERSION_STRING);
    ...
    #endif
    #ifdef STRING_CONFIG_H_LICENSE
      SERIAL_ECHO_START;
      SERIAL_ECHOPGM(MSG_LICENSE);
      SERIAL_ECHOPGM(STRING_CONFIG_H_LICENSE);
    #endif
    #ifdef STRING_CONFIG_H_CFG_DEFS
      SERIAL_ECHO_START;
      SERIAL_ECHOPGM(MSG_CFG_DEFS);
      SERIAL_ECHOPGM(STRING_CONFIG_H_CFG_DEFS);
    #endif
  #endif
  SERIAL_ECHO_START;
